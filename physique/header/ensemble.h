...
class Ensemble {
    ...
    void evolution(float dt, float g,float rayon_influence, float m,float multipression,float dvisee,float coef,float viscstrength,bool clique_gauche,bool clique_droit,float sourisx,float sourisy,float rayon_action_clique_gauche, float puissance_action);
